...
VALIDATE_ALL_PDF_PAGES = _env_bool("VALIDATE_ALL_PDF_PAGES", False)

TEXT_MIN_QUALITY_SCORE = int(os.getenv("TEXT_MIN_QUALITY_SCORE", "60"))
TEXT_MAX_INVALID_CHAR_RATIO = float(os.getenv("TEXT_MAX_INVALID_CHAR_RATIO", "0.3"))

SENTENCE_TRANSFORMER_MODEL_NAME = os.getenv("SENTENCE_TRANSFORMER_MODEL_NAME")
SEARCH_SEMANTIC_MIN_SCORE = float(os.getenv("SEARCH_SEMANTIC_MIN_SCORE", "0.7"))
SEARCH_HYBRID_MIN_SCORE = float(os.getenv("SEARCH_HYBRID_MIN_SCORE", "1.0"))
SEARCH_KNN_POOL_SIZE = int(os.getenv("SEARCH_KNN_POOL_SIZE", "1000"))
